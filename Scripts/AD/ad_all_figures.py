...
FIGURES_DIR = Path('Results/Figures/AD')  # Using AD dataset
...
def load_all_results():
    ...
    methods = {
        'scVI_RNA_ONLY': 'Results/Metrics/AD_scVI_RNA_only/classification_results_scVI_summary.csv',
        'scVI_RNA_ATAC': 'Results/Metrics/AD_scVI_RNA_ATAC/classification_results_scVI_summary.csv',
        'PCA_RNA_ONLY': 'Results/Metrics/AD_PCA_RNA_ONLY/classification_results_PCA_summary.csv',
        'PCA_RNA_ATAC': 'Results/Metrics/AD_PCA_RNA_ATAC/classification_results_PCA_summary.csv',
        'FA_RNA_ONLY': 'Results/Metrics/AD_FA_RNA_ONLY/classification_results_FA_summary.csv',
        'FA_RNA_ATAC': 'Results/Metrics/AD_FA_RNA_ATAC/classification_results_FA_summary.csv',
    }
