...
Input: Data/processed/AD/ad_mofa_annotated.h5ad
Output: Results/Metrics/AD_scVI/classification_results_scVI_*.csv
"""
...
def main():
    ...
    # Paths
    INPUT_PATH = 'Data/processed/AD/ad_mofa_annotated_RNA_only.h5ad'
    OUTPUT_DIR = 'Results/Metrics/AD/scVI_RNA_ONLY'
    MODELS_DIR = 'Models/AD/scVI_RNA_ONLY'
