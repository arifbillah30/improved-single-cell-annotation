...
Input: Data/processed/PBMC/pbmc_mofa_annotated_RNA_ATAC.h5ad
Output: Results/Metrics/scVI_RNA_ATAC/classification_results_scVI_*.csv
"""
...
def main():
    ...
    # Paths
    INPUT_PATH = 'Data/processed/PBMC/pbmc_mofa_annotated_RNA_ATAC.h5ad'
    OUTPUT_DIR = f'Results/Metrics/scVI_RNA_ATAC'
    MODELS_DIR = f'Models/scVI_RNA_ATAC'
