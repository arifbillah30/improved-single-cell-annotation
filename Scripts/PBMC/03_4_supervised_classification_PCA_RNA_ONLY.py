...
Input: Data/processed/PBMC/pbmc_mofa_annotated_RNA_only.h5ad
Output: Results/Metrics/PCA_RNA_only/classification_results_PCA_*.csv
"""
...
# Output directories
RESULTS_DIR = 'Results/Metrics/PCA_RNA_ONLY'
MODELS_DIR = 'Models/PCA_RNA_ONLY'
...
def main():
    ...
    # Load data
    data_path = 'Data/processed/PBMC/pbmc_mofa_annotated_RNA_only.h5ad'
