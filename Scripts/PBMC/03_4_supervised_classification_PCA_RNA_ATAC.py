...
Output: Results/Metrics/PCA_RNA_ATAC/classification_results_PCA_*.csv
"""
...
# Output directories
RESULTS_DIR = 'Results/Metrics/PCA_RNA_ATAC'
MODELS_DIR = 'Models/PCA_RNA_ATAC'
...
def main():
    ...
    # Load data
    data_path = 'Data/processed/PBMC/pbmc_mofa_annotated_RNA_ATAC.h5ad'
